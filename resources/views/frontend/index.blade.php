        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-md-8 text-center">
                    <h4>Welcome to My Ecommerce Website</h4>
                    <div class="underline mx-auto"></div>
                    <p>
                        Lorem, ipsum dolor sit amet consectetur adipisicing elit.
                        Pariatur saepe nulla maxime provident! Veniam maiores quaerat libero,
                        doloribus doloremque tempore eos, natus ipsum delectus laboriosam in,
                        eius dolor voluptas error?
                    </p>
                </div>
            </div>
        </div>
