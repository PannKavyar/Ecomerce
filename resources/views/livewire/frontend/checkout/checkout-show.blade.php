        ...
        <div class="container">
                        ...
                        <div class="shadow bg-white p-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model.live="fullname" class="form-control"
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model.live="pincode" class="form-control"
                                ...
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea wire:model.live="address" class="form-control" rows="2"></textarea>
                                    @error('address')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                                <div class="col-md-12 mb-3">
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        <div class="nav col-md-3 flex-column nav-pills me-3" id="v-pills-tab"
                                            ...
                                            <button class="nav-link fw-bold" wire:loading.attr="disable"
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane active show fade" id="cashOnDeliveryTab"
                                                ...
                                                <hr />
                                                <button type="button" wire:loading.attr="disable" wire:click="codOrder"
            ...
            @else
                <div class="card card-body shadow text-center p-md-5">
                    <h4>No Items in card to checkout</h4>
                    <a href="">Shop now</a>
                </div>
            @endif
        </div>
