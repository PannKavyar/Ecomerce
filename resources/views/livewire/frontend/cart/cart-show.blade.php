        ...
        <div class="container">
                                ...
                                <div class="cart-item">
                                    <div class="row">
                                        <div class="col-md-6 my-auto">
                                            <a
                                                href="{{ route('frontend.productView', ['category_slug' => $cartItem->product->category->slug, 'product_slug' => $cartItem->product->slug]) }}">
            ...
            <div class="row">
                <div class="col-md-8 my-md-auto mt-3">
                    <h4>Get the best deals and offers
                        <a href="{{ route('frontend.category') }}">Shop Now</a>
                    </h4>
                </div>
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        ...
                        <hr>
                        <a href="{{ route('checkout.index') }}" class="btn btn-warning w-100">Check Out</a>
                    </div>
                </div>
            </div>
