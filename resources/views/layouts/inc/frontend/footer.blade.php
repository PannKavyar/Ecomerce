<div>
    <div class="footer-area">
        <div class="container">
            <div class="row">
                <div class="col-md-3">
                    <h4 class="footer-heading">{{ $appSetting->website_name ?? 'Pann E-Commerce' }}</h4>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2"><a href="{{ url('/feature-products') }}" class="text-white">Featured
                            Products</a></div>
                ...
                <div class="col-md-3">
                    ...
                    <div class="mb-2">
                        <p>
                            ...
                            {{ $appSetting->address ?? 'your address' }}
                        </p>
                    </div>
                    <div class="mb-2">
